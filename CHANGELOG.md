...
- Changelog update
- Release ratatui-which-key version 0.12.0
## [0.11.0] - 2026-05-05

### ⚙️ Miscellaneous Tasks

- Changelog update
- Release ratatui-which-key version 0.11.0
## [0.9.0] - 2026-05-02
...
- Filter out groups that are part of other scopes
...
- Version bump
- Changelog update
- Release ratatui-which-key version 0.6.1
## [0.6.0] - 2026-04-03
...
- Auto-add leader group description on keymap creation
...
- Show correct code in README
## [0.2.0] - 2026-03-23

### 🐛 Bug Fixes

- Filter bindings and navigation by scope
## [0.1.1] - 2026-03-23
